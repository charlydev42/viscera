// ParasiteLookAndFeel.cpp — Neumorphic theme with programmatic knobs
#include "ParasiteLookAndFeel.h"
#include "ModSlider.h"
#include <BinaryData.h>

// --- Neumorphic helper ---
void ParasiteLookAndFeel::drawNeumorphicRect(juce::Graphics& g,
...
void ParasiteLookAndFeel::setDarkMode(bool dark)
{
    ...
    if (dark)
    {
        ...
        kToggleOn    = 0xFFA4D65A;
        kToggleOff   = 0xFF3B4252;
...
void ParasiteLookAndFeel::drawRotarySlider(juce::Graphics& g,
...
void ParasiteLookAndFeel::drawToggleButton(juce::Graphics& g,
...
void ParasiteLookAndFeel::drawComboBox(juce::Graphics& g,
...
juce::Font ParasiteLookAndFeel::getComboBoxFont(juce::ComboBox&)
{
    return juce::Font(juce::Font::getDefaultMonospacedFontName(), 12.0f, juce::Font::plain);
}

void ParasiteLookAndFeel::positionComboBoxText(juce::ComboBox& box, juce::Label& label)
{
...
juce::Font ParasiteLookAndFeel::getLabelFont(juce::Label&)
{
    return juce::Font(juce::Font::getDefaultMonospacedFontName(), 11.0f, juce::Font::plain);
}

// TextButton text
void ParasiteLookAndFeel::drawButtonText(juce::Graphics& g, juce::TextButton& button,
                                         bool, bool)
{
...
void ParasiteLookAndFeel::drawButtonBackground(juce::Graphics& g, juce::Button& button,
...
void ParasiteLookAndFeel::fillTextEditorBackground(juce::Graphics& g, int width, int height,
...
void ParasiteLookAndFeel::drawTextEditorOutline(juce::Graphics& g, int width, int height,
                                                 juce::TextEditor& editor)
{
...
void ParasiteLookAndFeel::drawPopupMenuBackground(juce::Graphics& g, int width, int height)
{
    auto bounds = juce::Rectangle<int>(0, 0, width, height).toFloat();
    float cr = 14.0f;
...
void ParasiteLookAndFeel::preparePopupMenuWindow(juce::Component& newWindow)
{
    newWindow.setOpaque(false);
    newWindow.setRepaintsOnMouseActivity(true);
}

void ParasiteLookAndFeel::drawPopupMenuItem(juce::Graphics& g, const juce::Rectangle<int>& area,
...
void ParasiteLookAndFeel::drawPopupMenuSectionHeader(juce::Graphics& g,
...
void ParasiteLookAndFeel::getIdealPopupMenuItemSize(const juce::String& text, bool isSeparator,
...
int ParasiteLookAndFeel::getPopupMenuBorderSize()
{
    return 10; // 4px transparent margin + 6px inner padding
}

int ParasiteLookAndFeel::getMenuWindowFlags()
{
